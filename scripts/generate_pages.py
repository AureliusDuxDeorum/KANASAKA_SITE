...
TERMS_BODY = """
  <section class="hero compact">
    ...
    <p>Effective date: 21 August 2026</p>
  </section>
  ...
  <section class="page-section legal-document">
    <article class="content-card legal-card">
      <section class="tos-section">
        ...
        <p>By accessing or using the KANASAKA website at kanasaka.com (the &ldquo;Site&rdquo;), creating an account, purchasing a subscription, or using software or downloads made available through the Site, you agree to be bound by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree, do not use the Site or our services.</p>
      </section>
      ...
      <section class="tos-section">
        <h2>6. Subscriptions and Billing (KS_Package)</h2>
        ...
        <p><strong>6.2 Pricing.</strong> Current list prices are &euro;10.00 per month or &euro;100.00 per year. The price shown at checkout is the price that applies to your purchase. We may change prices for future billing periods with reasonable notice where required by law.</p>
        <p><strong>6.3 Payment processing.</strong> Payments are processed by Stripe. By subscribing, you also agree to Stripe&rsquo;s applicable terms and privacy practices for payment processing. We do not store full payment card numbers on our servers.</p>
      ...
      <section class="tos-section">
        ...
        <p>To the fullest extent permitted by law, KANASAKA and its operators will not be liable for indirect, incidental, special, consequential, or punitive damages, or for loss of profits, data, or goodwill arising from your use of the Site, subscriptions, or software. Our total liability for any claim relating to the Site or services will not exceed the greater of &euro;100 or the amount you paid us (if any) in the twelve months before the claim.</p>
      </section>
        ...
        <div id="settings-content" class="settings-panels-wrap" hidden>
          ...
          <section id="settings-panel-billing" class="settings-panel" hidden>
            ...
            <div id="billing-developer" class="settings-billing-callout settings-billing-developer" hidden>
              ...
              <p>Your @dev_ks developer account includes permanent full access to KS Stocks, downloads, and internal products.</p>
            </div>
